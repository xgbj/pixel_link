...
def create_dataset_batch_queue(dataset):
    ...
    with tf.device('/cpu:0'):
        ...
        [image, glabel, gbboxes, \
         x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, \
         y1, y2, y3, y4, y5, y6, y7, y8, y9, y10, y11, y12, y13, y14] = provider.get([
                                                         'image',
                                                         'object/label',
                                                         'object/bbox', 
                                                         'object/polygon/x1',
        ...
        gxs = tf.transpose(tf.stack([x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14])) #shape = (N, 4)
        gys = tf.transpose(tf.stack([y1, y2, y3, y4, y5, y6, y7, y8, y9, y10, y11, y12, y13, y14]))
