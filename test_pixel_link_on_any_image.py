...
# =========================================================================== #
tf.app.flags.DEFINE_string('checkpoint_path', '/media/xgbj/9132EE0B9756C987/model/pixel_link/conv2_2/model.ckpt-73018',
...
tf.app.flags.DEFINE_float('pixel_conf_threshold',  0.4, 'threshold on the pixel confidence')
tf.app.flags.DEFINE_float('link_conf_threshold',  0.4, 'threshold on the link confidence')
